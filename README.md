...
This is an Express app used in message apps such as Facebook Messenger, Slack and Twilo.

## Set-up Information:
* Download the zip file or run `git clone https://github.com/Okwonks/lycity-bot.git` in your terminal
* `cd <folder-name>`
...
## Getting credentials
In order to make the bot work you will need to set up a number of credentials. For this bot Watson Conversation by IBM is the AI behind the bot.
